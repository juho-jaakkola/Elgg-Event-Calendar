...
return array (
	...
	'event_calendar:required' => "必須。",
	'event_calendar:new_event' => "新しいイベント",
	'event_calendar:no_such_event_edit_error' => "エラー: そのようなイベントは存在しないか、あなたに編集権限がありません。",
	'event_calendar:add_event_title' => "イベントを追加",
	'event_calendar:manage_event_title' => "イベントを編集",
	'event_calendar:manage_event_description' => "イベントの詳細を下に記入してください。"
		."タイトル、場所、開始日は必須です。"
		."カレンダーアイコンをクリックすると開始日と終了日を設定できます。",
	'event_calendar:title_label' => "タイトル",
	'event_calendar:title_description' => "おおむね1から4語程度",
	'event_calendar:brief_description_label' => "概要",
	'event_calendar:brief_description_description' => "短い概要",
	'event_calendar:venue_label' => "場所",
	'event_calendar:venue_description' => "どこで開催されますか?",
	'event_calendar:start_date_label' => "開始日",
	'event_calendar:start_date_description'	=> "いつ開始しますか?",
	'event_calendar:end_date_label' => "終了日",
	'event_calendar:end_date_description'	=> "いつ終了しますか?設定がない場合"
		."開始日が用いられます。",
	'event_calendar:start_time_label' => "開始時刻",
	'event_calendar:start_time_description'	=> "何時に開始しますか?",
	'event_calendar:end_time_label' => "終了時刻",
	'event_calendar:end_time_description'	=> "何時に終了しますか?",
	'event_calendar:fees_label' => "料金",
	'event_calendar:fees_description'	=> "もし存在するならば、このイベントの料金。",
	'event_calendar:contact_label' => "連絡先",
	'event_calendar:contact_description'	=> "詳細情報の問い合わせ先、"
			."電話番号かメールアドレスがよいでしょう。",
	'event_calendar:organiser_label' => "主催者",
	'event_calendar:organiser_description'	=> "このイベントに責任のある個人または団体です。",
	'event_calendar:event_tags_label' => "タグ",
	'event_calendar:event_tags_description'	=> "関連するタグ(カンマ区切り)。",
	'event_calendar:long_description_label' => "説明",
	'event_calendar:long_description_description'	=> "必要なだけ(1以上)の段落。",
	'event_calendar:manage_event_response' => "保存されました。",
	'event_calendar:add_event_response' => "追加されました。",
	'event_calendar:manage_event_error' => "エラー:保存中にエラーが発生しました。"
			."必須項目を入力しているか確認してください。",
	'event_calendar:error_nosuchevent' => "エラー:そのようなイベントはありません。",
	'event_calendar:show_events_title' => "イベントカレンダー",
	'event_calendar:day_label' => "日",
	'event_calendar:week_label' => "週",
	'event_calendar:month_label' => "月",
	'event_calendar:group' => "グループカレンダー",
	'event_calendar:new' => "イベントを追加",
	'event_calendar:submit' => "保存して継続",
	'event_calendar:cancel' => "キャンセル",
	'event_calendar:widget_title' => "イベントカレンダー",
	'event_calendar:widget:description' => "あなたのイベントを見る。",
	'event_calendar:num_display' => "表示するイベントの数",
	'event_calendar:groupprofile' => "将来のイベント",
	'event_calendar:view_calendar' => "カレンダーを見る",
	'event_calendar:when_label' => "いつ",
	'event_calendar:site_wide_link' => "すべてのイベントを見る",
	'event_calendar:view_link' => "このイベントを見る",
	'event_calendar:edit_link' => "このイベントを編集",
	'event_calendar:delete_link' => "このイベントを削除",
	'event_calendar:delete_response' => "削除されました。",
	'event_calendar:error_delete' => "イベントが存在しないか、あなたに削除権限がありません。",
	'event_calendar:delete_cancel_response' => "削除はキャンセルされました。",
	'event_calendar:add_to_my_calendar' => "自分のカレンダーに追加",
	'event_calendar:remove_from_my_calendar' => "自分のカレンダーから削除",
	'event_calendar:add_to_my_calendar_response' => "あなたの個人カレンダーに追加されました。",
	'event_calendar:add_to_my_calendar_error' => "あなたの個人カレンダーに追加できませんでした。"
				."(イベントが満員かあなたの個人カレンダーに同時刻にすでにイベントが入ってないですか?)",
	'event_calendar:remove_from_my_calendar_response' => "あなたの個人カレンダーから削除されました。",
	'event_calendar:add_to_the_calendar' => "カレンダーに追加",
	'event_calendar:remove_from_the_calendar' => "削除",
	'event_calendar:add_to_the_calendar_menu_text' => "私のカレンダーに追加",
	'event_calendar:remove_from_the_calendar_menu_text' => "私のカレンダーから削除",
	'event_calendar:remove_from_the_calendar_button' => "カレンダーから削除",
	'event_calendar:added_to_the_calendar' => "カレンダーに追加されました",
	'event_calendar:removed_from_the_calendar' => "カレンダーから削除されました",
	'event_calendar:add_to_the_calendar_response' => "この人のカレンダーに追加されました。",
	'event_calendar:add_to_the_calendar_error' => "この人のカレンダーに追加できませんでした。"
				."(イベントが満員かこの人の個人カレンダーに同時刻にすでにイベントが入ってないですか?)",
	'event_calendar:remove_from_the_calendar_response' => "この人の個人カレンダーから削除されました。",

	'event_calendar:users_for_event_menu_title' => "個人カレンダーにこのイベントを追加している人たち",
	'event_calendar:users_for_event_title' => "\"%s'\"の個人カレンダー",
	'event_calendar:personal_event_calendars_link' => "%s個のカレンダー",
	'event_calendar:personal_event_calendars_link_one' => "1個のカレンダー",
	'event_calendar:users_for_event_breadcrumb' => "個人カレンダー",
	'event_calendar:settings:group_profile_display:title' => "グループカレンダープロフィールの表示(グループカレンダーが有効な場合)",
	'event_calendar:settings:group_profile_display_option:left' => "左カラム",
	'event_calendar:settings:group_profile_display_option:right' => "右カラム",
	'event_calendar:settings:group_profile_display_option:none' => "表示しない",
	'event_calendar:settings:times:title' => "日付だけでなく時間も追加",
	'event_calendar:settings:autopersonal:title' => "自動的に作成者のカレンダーに追加。",
	'event_calendar:settings:autogroup:title' => "自動的にグループメンバー全員のカレンダーに追加。",
	'event_calendar:settings:agenda_view:title' => "予定表を見る",
	'event_calendar:settings:venue_view:title' => "概要画面(イベントリスト)で場所を表示",
	'event_calendar:settings:yes' => "はい",
	'event_calendar:settings:no' => "いいえ",
	'event_calendar:settings:site_calendar:title' => "サイトカレンダー",
	'event_calendar:settings:site_calendar:admin' => "はい、管理者だけがイベントを投稿できます",
	'event_calendar:settings:site_calendar:loggedin' => "はい、すべてのログインユーザがイベントを投稿できます",
	'event_calendar:settings:group_calendar:title' => "グループカレンダー",
	'event_calendar:settings:group_calendar:admin' => "はい、管理者とグループ所有者だけがイベントを投稿できます",
	'event_calendar:settings:group_calendar:members' => "はい、グループメンバー全員がイベントを投稿できます",
	'event_calendar:settings:group_default:title' => "新しいグループがデフォルトでグループカレンダーを持つか(もし有効ならば)",
	'event_calendar:settings:group_default:no' => "いいえ(ただし望むなら管理者とグループオーナーは有効にできます)",
	'event_calendar:settings:group_default:yes' => "はい(ただし望むなら管理者とグループオーナーは無効にできます)",
	'event_calendar:settings:group_always_display:title' => "グループカレンダーが有効なら、常に表示する(たとえ空でも)",
	'event_calendar:settings:region_display:title' => "地域フィールドを追加",
	'event_calendar:settings:region_list:title' => "地域一覧(1行に1つ)",
	'event_calendar:region_label' => "地域",
	'event_calendar:region_description' => "開催地域を選択してください。",
	'event_calendar:settings:type_display:title' => "イベントタイプを追加",
	'event_calendar:settings:type_list:title' => "イベントタイプ一覧(1行に1つ)",
	'event_calendar:settings:type_list:desc' => 'フルカレンダービューではイベントタイプごとに背景色として利用されるCSSカラーバリューを指定できます。タイプと色を|で区切ってください。例: "meeting|#00CC33"',
	'event_calendar:type_label' => "タイプ",
	'event_calendar:type_description' => "イベントのタイプを選択してください。",
	'event_calendar:all' => "すべて",
	'event_calendar:region_filter_by_label' => "地域でフィルタ: ",
	'event_calendar:settings:first_date:title' => "検索開始日(YYYY-MM-DD形式)",
	'event_calendar:settings:last_date:title' => "検索終了日(YYYY-MM-DD形式)",
	'event_calendar:enable_event_calendar' => "グループカレンダーを有効にする",
	'event_calendar:no_events_found' => "イベントが見つかりません。",
	'event_calendar:mine' => "私のカレンダー",
	'event_calendar:feature' => "特集する",
	'event_calendar:unfeature' => "特集解除",
	'event_calendar:agenda:column:time' => "時刻",
	'event_calendar:agenda:column:session' => "Session",
	'event_calendar:agenda:column:venue' => "場所",
	'event_calendar:upcoming_events_title' => "予定イベント",
	'event_calendar:settings:paged' => "paged",
	'event_calendar:settings:agenda' => "agenda",
	'event_calendar:settings:month' => "月別",
	'event_calendar:settings:full' => "フルビュー",
	'event_calendar:settings:listing_format:title' => "イベントリストフォーマット",
	'event_calendar:paged:column:date' => "日付",
	'event_calendar:paged:column:time'	=> "時刻",
	'event_calendar:paged:column:event' => "イベント",
	'event_calendar:paged:column:venue' => "場所",
	'event_calendar:paged:column:calendar' => "カレンダー",
	...
	'event_calendar:settings:no_collisions:title' => "衝突検知:1人の個人カレンダーに同日時に2以上のイベントが入ることを防ぎます",
	'event_calendar:settings:collision_length:title' => "終了日時の指定がない場合の推測イベント継続秒数"
		."(衝突検知用)。デフォルトは3600秒(1時間)。",
	...
	'event_calendar:open' => "オープン",
	'event_calendar:settings:add_users:title' => "イベント作成者とサイト管理者は他の人のカレンダーにイベントを追加できます。",
	'event_calendar:add_user_label' => "ユーザーを追加",
...
",
	...
	'event_calendar:settings:timeformat:title' => "時刻書式",
	'event_calendar:time_format:12hour' => "12時間制(AM/PM)",
	'event_calendar:time_format:24hour' => "24時間制",
	...
	'event_calendar:day_abbrev:monday' => "月",
	'event_calendar:day_abbrev:tuesday' => "火",
	'event_calendar:day_abbrev:wednesday' => "水",
	'event_calendar:day_abbrev:thursday' => "木",
	'event_calendar:day_abbrev:friday' => "金",
	'event_calendar:day_abbrev:saturday' => "土",
	'event_calendar:day_abbrev:sunday' => "日",
	'event_calendar:dow:full:monday' => "月曜日",
	'event_calendar:dow:full:tuesday' => "火曜日",
	'event_calendar:dow:full:wednesday' => "水曜日",
	'event_calendar:dow:full:thursday' => "木曜日",
	'event_calendar:dow:full:friday' => "金曜日",
	'event_calendar:dow:full:saturday' => "土曜日",
	'event_calendar:dow:full:sunday' => "日曜日",
