...
if ($event) {
	...
	if ($event_guid) {
		add_to_river('river/object/event_calendar/update', 'update', $user->guid, $event_guid);
		...
		add_to_river('river/object/event_calendar/create', 'create', $user->guid, $event->guid);
